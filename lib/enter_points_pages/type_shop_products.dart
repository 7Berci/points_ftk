...
class TypeShoppingSpace extends StatefulWidget {
  const TypeShoppingSpace({super.key});

  @override
  State<TypeShoppingSpace> createState() => _TypeShoppingSpaceState();
}

@override
Widget UserName() {
  if (userr.email == "eliel08@hotmail.fr") {
    return const Text("Berci Djélé", style: TextStyle(fontSize: 16.5));
  } else {
    return const Text("FTK Account", style: TextStyle(fontSize: 16.5));
  }
}

class _TypeShoppingSpaceState extends State<TypeShoppingSpace> {
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        recognizer:
                            TapGestureRecognizer()..onTap = goToShopPageBis,
                        text: "page d'accueil",
                        style: TextStyle(
