...
class ArchivesPressingScreenView extends State<ArchivesPressingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Points des transferts")),
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Center(
              child: Text("ARCHIVES DES TRASNFERTS",
                  style: TextStyle(
                    fontSize: 21.0,
              ...
              FutureBuilder<double>(
                ...
                builder: (context, snapshot) {
                    ...
                    pw.Page(
                      build: (pw.Context context) {
                        ...
                        return pw.Column(
                          ...
                          children: [
                            pw.Text(
                              'Points des transferts du mois de $moisNom $selectedYear',
                  ...
                  if (permissionGranted) {
                    ...
                    String outputFile = "${directory.path}/points_transferts_${selectedYear}_$selectedMonth.pdf";
