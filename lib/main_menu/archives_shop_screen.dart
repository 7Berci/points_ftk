...
class ArchivesShopScreen extends StatefulWidget {
  const ArchivesShopScreen({super.key});

  @override
  ArchivesShopScreenView createState() => ArchivesShopScreenView();
}

class ArchivesShopScreenView extends State<ArchivesShopScreen> {
  String? selectedYear;
  ...
  Future<List<String>> fetchMonths(String year) async {
    final snapshot =
        await FirebaseFirestore.instance
            ...
            .where(
              'timestamp',
              isGreaterThanOrEqualTo: DateTime(int.parse(year)),
            )
  ...
  Future<double> getReportAnterieur(String year, String month) async {
    ...
    final prevPoints = await fetchPointsForMonth(
      y.toString(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Points de shop")),
          ...
          children: [
            ...
            if (selectedYear != null)
              DropdownButton<String>(
                ...
                onChanged: (m) async {
                  selectedMonth = m;
                  points = await fetchPointsForMonth(
                    selectedYear!,
                    selectedMonth!,
                  );
                  setState(() {});
                ...
                builder: (context, snapshot) {
                  ...
                  Future<void> exportToPdf() async {
                      ...
                      pw.Page(
                        build: (pw.Context context) {
                          ...
                          return pw.Column(
                            ...
                            children: [
                              pw.Text(
                                'Points shop du mois de $moisNom $selectedYear',
                                style: pw.TextStyle(
                                  fontSize: 20,
                    ...
                    if (permissionGranted) {
                      ...
                      String outputFile =
                          "${directory.path}/points_shop_${selectedYear}_$selectedMonth.pdf";
