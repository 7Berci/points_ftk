...
class DailyShopScreen extends StatefulWidget {
  const DailyShopScreen({super.key});

  @override
  DailyShopScreenView createState() => DailyShopScreenView();
}
...
class DailyShopScreenView extends State<DailyShopScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text("Points de shop - ${moisLettre[now.month]} ${now.year}"),
        ),
