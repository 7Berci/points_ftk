...
class ArchivesPrintScreen extends StatefulWidget {
  const ArchivesPrintScreen({super.key});

  @override
  ArchivesPrintScreenView createState() => ArchivesPrintScreenView();
}

class ArchivesPrintScreenView extends State<ArchivesPrintScreen> {
  String? selectedYear;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Points d'impression")),
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Center(
              child: Text("ARCHIVES D'IMPRESSION",
                  style: TextStyle(
                    fontSize: 21.0,
              ...
              FutureBuilder<double>(
                ...
                builder: (context, snapshot) {
                  ...
                  pw.Page(
                    build: (pw.Context context) {
                      ...
                      return pw.Column(
                        ...
                        children: [
                          pw.Text(
                            'Points impression du mois de $moisNom $selectedYear',
                  ...
                  if (permissionGranted) {
                    ...
                    String outputFile = "${directory.path}/points_impression_${selectedYear}_$selectedMonth.pdf";
